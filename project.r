setwd("/media/sarthak/OS/Users/Sarthak/Desktop/Projects/CustomerSegmentation/data")
data=read.csv("/media/sarthak/OS/Users/Sarthak/Desktop/Projects/CustomerSegmentation/data/Mall_Customers.csv")
str(data)
names(data)
head(data)
summary(data$Age)
